...
class TestClass:
    def test_exception_state(self):
        ...
        result: MapperResult = Mapper.map_hex_address(
            compiler_output_json="tests/compiler0517/compiled/EtherLotto.json",
            address_hex=hex(249),
            contract_name="EtherLotto",)
        self._assert_code_in_line(result, 'assert(msg.value == TICKET_AMOUNT)', 37)
    ...
    def test_multiple_calls_in_a_single_transaction(self):
        ...
        result: MapperResult = Mapper.map_hex_address(
            ...
            address_hex=hex(488),
            contract_name="EtherLotto",)
        self._assert_code_in_line(result, 'msg.sender.transfer(pot - FEE_AMOUNT)', 53)
    ...
    def _assert_code_in_line(self, result: any, MapperResult: str, line: int):
        ...
        assert (result.file == "compiler0517/EtherLotto.sol")
